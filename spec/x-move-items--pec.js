...
describe("Given script with MOVE transitions and item in set", function() {

	before(function() {
	
		repo.flush();
		this.script = require("./scenarios/simple-moving");
	...
	describe("When the item is read", function() {
		...
		describe("and when the transition link is followed", function() {
			...
			itEventually("it should return a representation of the item with a link to the target set");
